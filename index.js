...
app.post("/", (req, res) => {
    ...
    const mailOptions = {
        ...
        <tr><td  style="padding-left: 10px">From: <span style="color: #C3B171; text-align: center;"><a href=mailto:${email}>${email}</a></span></td></tr>
        <tr><td  style="padding-left: 10px">${body}</td></tr>
